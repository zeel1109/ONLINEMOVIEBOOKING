<%-- 
    Document   : movies
    Created on : 15-Oct-2024, 7:41:26 am
                    ...
                    <div class="owl-four owl-carousel owl-theme">
                        <div class="item vhny-grid">
                            <div class="box16">
                                <a href="#" >
                                    <figure>
                                        <img class="img-fluid" src="assets/images/transformers-one-web-1200x675.jpg" style="height: 269.04px; width: 565px;" alt="">
                                    </figure>
                            ...
                            <div class="box16 mt-4">
                                <a href="#">
                                    <figure>
                                        <img class="img-fluid" src="assets/images/stree_2_big.jpg" style="height: 269.04px; width: 565px;" alt="">
                                    </figure>
                                    <div class="box-content">
                        ...
                        <div class="item vhny-grid">
                            <div class="box16">
                                <a href="#">
                                    <figure>
                                        <img class="img-fluid" src="assets/images/joker-folie-a-deux-joker-2.jpg" style="height: 269.04px; width: 565px;" alt="">
                                    </figure>
                                    <div class="box-content">
                                        <h3 class="title">Joker 2024</h3>
                                        <h4> <span class="post"><span class="fa fa-clock-o"> </span> 1 Hr 4min
                            ...
                            <div class="box16 mt-4">
                                <a href="#">
                                    <figure>
                                        <img class="img-fluid" src="assets/images/Munjya.jpeg" style="height: 269.04px; width: 565px;" alt="">
                                    </figure>
                                    <div class="box-content">
                                        <h3 class="title">Devara</h3>
                                        <h4> <span class="post"><span class="fa fa-clock-o"> </span> 1 Hr 4min
                ...
                <div class="container py-lg-4">
                    ...
                    <div class="w3l-populohny-grids">
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/devara.jpg" style="height: 354.51px; width: 265px;" alt="">
                                </figure>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/devara.jpg" class="img-fluid modalimg" alt="" / style="height:250px; width:350px;">
                                                     <p>
                        ...
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/joker.jpg" style="height: 354.51px; width: 265px;" alt="">
                                </figure>
                                ...
                                <div class="modal fade Knivesout" id="myModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/joker.jpg" class="img-fluid modalimg" alt="" / style="height:250px; width:350px;">
                                                     <p>
                        ...
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/stree_2.jpg" style="height: 354.51px; width: 265px;" alt="">
                                </figure>
                                ...
                                <div class="modal fade Bharat" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/stree_2.jpg" class="img-fluid modalimg" alt="" / style="height:250px; width:350px;">
                                                     <p>
                        ...
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/dharamveer_2.jpg" style="height: 354.51px; width: 265px;" alt="">
                                </figure>
                                ...
                                <div class="modal fade Jumanji" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/dharamveer_2.jpg" class="img-fluid modalimg" alt="" / style="height:250px; width:350px;">
                                                     <p>
                    ...
                    <div class="w3l-populohny-grids">
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/tumbbad.jpg" style="height: 392.31px; width: 265px;" alt="">
                                </figure>
                                <a href=".Rocketman" data-toggle="modal">
                                    <div class="box-content">
                                        <h3 class="title">Tumbbad</h3>
                                ...
                                <div class="modal fade Rocketman" id="myModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/tumbbad.jpg" class="img-fluid modalimg" alt="" / style="height:250px; width:350px;">
                                                     <p>
                        ...
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/transformers_one_ver7_xlg.jpg" style="height: 392.31px; width: 265px;" alt="">
                                </figure>
                                ...
                                <div class="modal fade Doctorsleep" id="myModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/transformers_one_ver7_xlg.jpg" class="img-fluid modalimg" alt="" /style="height:250px; width:350px;">
                                                     <p>
                        ...
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/The_Buckingham_Murders.jpeg" style="height: 392.31px; width: 265px;" alt="">
                                </figure>
                                ...
                                <div class="modal fade kabir" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/The_Buckingham_Murders.jpeg" class="img-fluid modalimg" alt="" /style="height:250px; width:350px;">
                                                     <p>
                        ...
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/white_bird.jpg" style="height: 392.31px; width: 265px;" alt="">
                                </figure>
                                ...
                                <div class="modal fade Joker" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/white_bird.jpg" class="img-fluid modalimg" alt="" / style="height:250px; width:350px;">
                                                     <p>
                    ...
                    <div class="w3l-populohny-grids">
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/Locha_Laapsi_Official_Poster.jpg" style="height: 390px; width: 265px;" alt="">
                                </figure>
                                <a href=".gk" data-toggle="modal">
                                    <div class="box-content">
                                        <h3 class="title">Locha Lapsi</h3>
                                ...
                                <div class="modal fade gk" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/Locha_Laapsi_Official_Poster.jpg" class="img-fluid modalimg" alt="" />
                                                <p>
                        ...
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/Navra_Maza_Navsacha_2.jpg" style="height: 390px; width: 265px;" alt="">
                                </figure>
                                <a href=".gujjubhai" data-toggle="modal">
                                    <div class="box-content">
                                        <h3 class="title">Navra Maza Navsacha 2</h3>
                                ...
                                <div class="modal fade gujjubhai" id="myModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/Navra_Maza_Navsacha_2.jpg" class="img-fluid modalimg" alt="" />
                                                <p>
                        ...
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/Jhamkudi_movie_poster.jpg" style="height: 390px; width: 265px;" alt="">
                                </figure>
                                <a href=".thaijase" data-toggle="modal">
                                    <div class="box-content">
                                        <h3 class="title">Jhamkudi</h3>
                                        <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 35min
                                ...
                                <div class="modal fade thaijase" id="myModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/Jhamkudi_movie_poster.jpg" class="img-fluid modalimg" alt="" />
                                                <p>
                        ...
                        <div class="item vhny-grid">
                            <div class="box16 mb-0">
                                <figure>
                                    <img class="img-fluid" src="assets/images/Frendo_film_official_poster.jpg" style="height: 390px; width: 265px;" alt="">
                                </figure>
                                <a href=".Reva" data-toggle="modal">
                                    <div class="box-content">
                                        <h3 class="title">Frendo</h3>
                                ...
                                <div class="modal fade Reva" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" id="mymodalcontent">
                                            ...
                                            <div class="modal-body" id="dynamic-content">
                                                <img src="assets/images/Frendo_film_official_poster.jpg" class="img-fluid modalimg" alt="" />
                                                <p>
                                ...
                                <div class="albums-content">
                                    <div class="row">
                                            ...
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html">
                                                        ...
                                                        <img src="assets/images/Munjya_2024.jpg" class="img-fluid"
                                                             alt="author image">
                                                ...
                                                <div class="message">
                                                    <p>Hindi</p>
                                                    <a class="author-book-title" href="movies.html">Munjya</a>
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/transformers_one_ver7_xlg.jpg" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>English</p>
                                                    <a class="author-book-title" href="movies.html">Transformers One</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/joker.jpg" style="height: 245.55px; width: 165px;" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>English</p>
                                                    <a class="author-book-title" href="movies.html">Joker 2024</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/stree_2.jpg" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>Hindi</p>
                                                    <a class="author-book-title" href="movies.html">Stree 2</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/tumbbad.jpg" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>Hindi</p>
                                                    <a class="author-book-title" href="movies.html">Tumbbad</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/Frendo_film_official_poster.jpg" style="height: 239.89px; width:239.89px;" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>Gujarati</p>
                                                    <a class="author-book-title" href="movies.html">Frendo</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/Jhamkudi_movie_poster.jpg" style="height: 248.79px;" class="img-fluid"
                                                                               alt="author image">
                                                        <span class="fa fa-play video-icon" aria-hidden="true"></span>
                                                    </a>
                                                </div>
                                                <div class="message">
                                                    <p>Gujarati</p>
                                                    <a class="author-book-title" href="movies.html">Jhamkudi</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/Locha_Laapsi_Official_Poster.jpg" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>Gujarati</p>
                                                    <a class="author-book-title" href="movies.html">Locha lapsi</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/white_bird.jpg" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>English</p>
                                                    <a class="author-book-title" href="movies.html">White Bird</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                ...
                                <div class="albums-content">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/my_fault.jpg" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>English</p>
                                                    <a class="author-book-title" href="movies.html">My Fault</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/animal.jpg" style="height: 248.79px;" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>hindi</p>
                                                    <a class="author-book-title" href="movies.html">Animal</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/p_deadpool_wolverine_snuggle_gen_v2_c251bde1.jpeg" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>English</p>
                                                    <a class="author-book-title" href="movies.html">Deadpool & Wolverine</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/venom_3_3.jpg" style="height: 248px;" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>English</p>
                                                    <a class="author-book-title" href="movies.html">Venom 3</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/Bhool Bhulaiyaa 3.jpeg" style="height: 248px;" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>Hindi</p>
                                                    <a class="author-book-title" href="movies.html">Bhool Bhulaiyaa 3</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
                                        ...
                                        <div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
                                            <div class="slider-info">
                                                <div class="img-circle">
                                                    <a href="movies.html"><img src="assets/images/vedaa_1707293626379.jpg" style="height: 248px;" class="img-fluid"
                                                                               alt="author image">
                                                        <div class="overlay-icon">
                                                ...
                                                <div class="message">
                                                    <p>Hidi</p>
                                                    <a class="author-book-title" href="movies.html">Vedaa</a>
                                                    <h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
